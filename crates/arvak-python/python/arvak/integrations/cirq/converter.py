...
# Shared QASM 2.0 ↔ 3.0 helpers now live in integrations/_qasm.py; the
# underscore aliases stay importable from here for existing callers.
from .._qasm import qasm2_to_qasm3 as _qasm2_to_qasm3
from .._qasm import qasm3_to_qasm2 as _qasm3_to_qasm2

...
//!
//! # HAL Contract v2.2 — InternalCode Extension
//!
...
pub struct Capabilities {
    ...
    /// Physical cooling layer profile (HAL Contract v2.2, InternalCode extension).
    ///
    /// Captures the cryogenic cooling infrastructure characteristics used by
    /// InternalCode for hardware attestation, tamper detection, and quiet-window
...
impl Capabilities {
    ...
    /// Transfer function and PUF enrollment are populated after InternalCode enrollment.
    ...
    ///
    /// Enables InternalCode hardware attestation, tamper detection, and
...
// ─── HAL Contract v2.2 / v2.3 — InternalCode Physical Layer Extension ─────────────
...
pub enum CompressorType {
    ...
    /// Produces characteristic ~1 Hz vibration. Primary InternalCode PUF signal.
    RotaryValve,
...
/// temperature. Used by InternalCode to characterise the Physical Unclonable
...
///
/// This is the InternalCode extension to the HAL Contract (v2.2). Where
...
pub struct CoolingProfile {
    ...
    /// Used by the InternalCode scheduler to time circuit execution.
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
...
/// Decoherence monitor trait for InternalCode physical-layer attestation.
///

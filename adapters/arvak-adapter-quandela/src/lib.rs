...
//! - **Cooling**: 4K Gifford-McMahon cryocooler — tracked via InternalCode for
//!   HOM visibility PUF fingerprinting
//! - **Submission**: REST API (DEBT-Q5: endpoint TBD)
//!
//! # InternalCode Integration
//!
//! Use `QuandelaBackend::ingest_internalcode_enrollment` to populate the
//! `CoolingProfile` PUF enrollment from internalcode-lab output.
//! Use `QuandelaBackend::ingest_internalcode_schedule` to add quiet-window hints.
//!
//! # Authentication
//!
